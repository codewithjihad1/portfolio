import { levelColor, skills } from '@/data/portfolio';
        ...
        <section id="skills" className="py-24 bg-white dark:bg-slate-950">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl font-bold text-slate-900 dark:text-white mt-2">My Skills</h2>
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
                    {[
                        ...
                        <div key={level} className="flex items-center gap-2">
                            <span className={`text-xs font-semibold px-2.5 py-1 rounded-full ${color}`}>{level}</span>
                        </div>
                    ))}
                </div>
            </div>
