...
import { MapPinIcon, EmailIcon, PhoneIcon } from "@/components/Icons";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="relative w-72 h-72 rounded-2xl overflow-hidden border-4 border-blue-500/20 shadow-2xl">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
              ...
              has evolved into a deep passion for building scalable, user-centric applications.
            </p>
